...
let Icon = require("@idraw/studio/lib/studio/mods/icon/index");
...
let IconText = React.createElement(Icon.IconText, defaultIconProps);
let IconCircle = React.createElement(Icon.IconCircle, defaultIconProps);
let IconSVG = React.createElement(Icon.IconSVG, defaultIconProps);
let IconHTML = React.createElement(Icon.IconHTML, defaultIconProps);

let IconRect = React.createElement(Icons.BorderOutlined, defaultIconsProps);
let IconImage = React.createElement(Icons.FileImageOutlined, defaultIconsProps);
